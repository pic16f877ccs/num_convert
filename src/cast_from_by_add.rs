...
/// // -128_i8 -> 0_u32
/// assert_eq!(<u32 as CastFromByAdd>::from_i8(<i8>::MIN), <u8>::MIN as u32);
/// // 127_i8 -> 255_u64
/// assert_eq!(<u64 as CastFromByAdd>::from_i8(<i8>::MAX), <u8>::MAX as u64);
/// ```
pub trait CastFromByAdd {
